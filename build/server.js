...
/** Connect to Mongo */
mongoose_1.default.set("strictQuery", false); //Mongoose: the `strictQuery` option will be switched back to `false` by default in Mongoose 7
...
const StartServer = () => {
    ...
    router.use(express_1.default.urlencoded({ extended: true })); //house-keeping
